...
{	
	...
	UKismetSystemLibrary::ComponentOverlapComponents(volume, volume->GetComponentTransform(), ObstacleList, NULL, ActorsToIgnoreForCollision, obstacles);
	...
	else
	{
		...
		UKismetSystemLibrary::ComponentOverlapComponents(volume, volume->GetComponentTransform(), NAVOverlapQuery, UDoNNavigationVolumeComponent::StaticClass(), ActorsToIgnoreForCollision, neighboringVolumeComponents);
...
UDoNNavigationVolumeComponent* ADEPRECATED_VolumeAdaptiveBuilder::GetNAVVolumeFromComponent(UPrimitiveComponent* Component, FVector ComponentAt)
{
	...
	UKismetSystemLibrary::ComponentOverlapComponents(Component, transform, NAVOverlapQuery, UDoNNavigationVolumeComponent::StaticClass(), ActorsToIgnoreForCollision, overlappingComponents);
