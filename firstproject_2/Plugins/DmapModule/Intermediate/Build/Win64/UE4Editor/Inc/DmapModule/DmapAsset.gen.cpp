...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_m_dimensions_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_m_dimensions;
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDmapAsset_Statics::NewProp_m_data_Inner = { "m_data", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FIntVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDmapAsset_Statics::NewProp_m_dimensions_MetaData[] = {
		{ "Category", "DmapAsset" },
		{ "ModuleRelativePath", "Public/DmapAsset.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDmapAsset_Statics::NewProp_m_dimensions = { "m_dimensions", nullptr, (EPropertyFlags)0x0020080000000014, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDmapAsset, m_dimensions), Z_Construct_UScriptStruct_FIntVector, METADATA_PARAMS(Z_Construct_UClass_UDmapAsset_Statics::NewProp_m_dimensions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDmapAsset_Statics::NewProp_m_dimensions_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDmapAsset_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDmapAsset_Statics::NewProp_m_dimensions,
	};
	...
	IMPLEMENT_CLASS(UDmapAsset, 1105744344);
